...
void read_move_data_from_battle_moves(vector<Move> &moveList)
{
    printf("Reading data from battle_moves.h\n");
    ...
    printf("Reading data from move_names.h\n");
...
void read_move_desc_from_move_descriptions(vector<Move> &moveList)
{
    printf("Reading data from move_descriptions.c\n");
...
void write_csv_data(vector<Move> &moveList)
{
    ...
    FILE *writePointer = fopen("./moves/moves_info.csv", "w");
