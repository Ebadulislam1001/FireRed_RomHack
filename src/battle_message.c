...
static const u8 sText_PkmnChangedAbility[] = _("{B_ATK_NAME_WITH_PREFIX} changed\nthe ability into {B_BUFF1}!"); // I was wroking here
...
static const u8 sText_ElectricityWeakened[] = _("Electricity and Fire\npowers are weakened!");
static const u8 sText_FireWeakened[] = _("Electricity and Fire\npowers are weakened!");
...
static const u8 sText_PkmnCutsPhAttackWith[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\ncuts {B_DEF_NAME_WITH_PREFIX}'s Ph.ATTACK!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
    ...
    [STRINGID_PKMNCUTSPHATTACKWITH - BATTLESTRINGS_TABLE_START]          = sText_PkmnCutsPhAttackWith,
