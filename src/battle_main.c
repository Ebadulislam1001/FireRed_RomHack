...
u8 IsRunningFromBattleImpossible(void)
{
    ...
    if (i != 0 && IS_BATTLER_OF_TYPE(gActiveBattler, TYPE_STEEL) &&  gBattleMons[gActiveBattler].ability != ABILITY_RUN_AWAY)
    {
...
u8 GetWhoStrikesFirst(u8 battler1, u8 battler2, bool8 ignoreChosenMoves)
{
    ...
    if (WEATHER_HAS_EFFECT)
    {
        ...
        || (gBattleMons[battler1].ability == ABILITY_SAND_RIDER && gBattleWeather & B_WEATHER_SANDSTORM))
        ...
        || (gBattleMons[battler2].ability == ABILITY_SAND_RIDER && gBattleWeather & B_WEATHER_SANDSTORM))
    ...
    if (gBattleMons[battler1].ability == ABILITY_OPPORTUNIST && gRandomTurnNumber%100 <= 25)
        speedBattler1 = UINT_MAX;
    ...
    if (gBattleMons[battler2].ability == ABILITY_OPPORTUNIST && gRandomTurnNumber%100 <= 25)
        speedBattler2 = UINT_MAX;
