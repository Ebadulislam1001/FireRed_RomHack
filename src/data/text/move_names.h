const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] = {
    ...
    [MOVE_SMOKESCREEN]   = _("POISON JAB"),
    [MOVE_CONFUSE_RAY]   = _("CONFUSE RAY"),
    [MOVE_WITHDRAW]      = _("SHADOW SNEAK"),
    [MOVE_DEFENSE_CURL]  = _("DEFENSE CURL"),
    [MOVE_BARRIER]       = _("ROCKY EXIT"),
    ...
    [MOVE_SELF_DESTRUCT] = _("BITTER CURE"),
    [MOVE_EGG_BOMB]      = _("SCORCH"),
    [MOVE_LICK]          = _("LICK"),
    [MOVE_SMOG]          = _("SPEED STRIKE"),
    [MOVE_SLUDGE]        = _("SLUDGE"),
    [MOVE_BONE_CLUB]     = _("BONE CLUB"),
    [MOVE_FIRE_BLAST]    = _("FIRE BLAST"),
    [MOVE_WATERFALL]     = _("WATERFALL"),
    [MOVE_CLAMP]         = _("ACCELEROCK"),
    [MOVE_SWIFT]         = _("SWIFT"),
    ...
    [MOVE_CONVERSION]    = _("HIDDEN SKILL"),
    ...
    [MOVE_SCARY_FACE]    = _("POWER UP HIT"),
    [MOVE_FAINT_ATTACK]  = _("FAINT ATTACK"),
    [MOVE_SWEET_KISS]    = _("SKYQUAKE"),
    ...
    [MOVE_VITAL_THROW]   = _("SLUDGE WAVE"),
    [MOVE_MORNING_SUN]   = _("MORNING SUN"),
    [MOVE_SYNTHESIS]     = _("FIERY SHOTS"),
    ...
    [MOVE_SMELLING_SALT] = _("FROSTBITE"),
    [MOVE_FOLLOW_ME]     = _("FOLLOW ME"),
    [MOVE_NATURE_POWER]  = _("NATURE POWER"),
    [MOVE_CHARGE]        = _("CHARGE UP"),
    [MOVE_TAUNT]         = _("TAUNT"),
    [MOVE_HELPING_HAND]  = _("KILING SPREE"),
    [MOVE_TRICK]         = _("TRICK"),
    ...
    [MOVE_MAGIC_COAT]    = _("BLACK MIRROR"),
    ...
    [MOVE_CAMOUFLAGE]    = _("HIDDEN TYPE"),
    [MOVE_TAIL_GLOW]     = _("DUAL CHOP"),
    [MOVE_LUSTER_PURGE]  = _("DARK PULSE"),
    [MOVE_MIST_BALL]     = _("DRAGON PULSE"),
    [MOVE_FEATHER_DANCE] = _("RETURN FIRE"),
    ...
    [MOVE_AROMATHERAPY]  = _("FOCUS BOOST"),
    ...
    [MOVE_GRASS_WHISTLE] = _("DRILL RUN"),
    ...
    [MOVE_WATER_SPORT]   = _("AZURE DRIVE"),
    ...
    [MOVE_DOOM_DESIRE]   = _("DRACO METEOR"),
