const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_PLUSLE] = _("AMONGUS-I"),
    [SPECIES_MINUN] = _("AMONGUS-II"),
    ...
    [SPECIES_ROSELIA] = _("BISHARP"),
    [SPECIES_SLAKOTH] = _("SLAKOTH"),
    [SPECIES_VIGOROTH] = _("VIGOROTH"),
    [SPECIES_SLAKING] = _("SLAKING"),
    [SPECIES_GULPIN] = _("FORKNIGHT"),
    [SPECIES_SWALOT] = _("BROOKFORCE"),
