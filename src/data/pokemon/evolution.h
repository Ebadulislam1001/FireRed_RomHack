const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_METAPOD]    = {{EVO_LEVEL, 15, SPECIES_BUTTERFREE}},
    ...
    [SPECIES_ODDISH]     = {{EVO_LEVEL, 22, SPECIES_GLOOM}},
    ...
    [SPECIES_MEOWTH]     = {{EVO_LEVEL, 27, SPECIES_PERSIAN}},
    
    [SPECIES_PSYDUCK]    = {{EVO_LEVEL, 26, SPECIES_GOLDUCK}},
    
    [SPECIES_MANKEY]     = {{EVO_LEVEL, 27, SPECIES_PRIMEAPE}},
    [SPECIES_PRIMEAPE]   = {{EVO_TRADE, 0, SPECIES_HITMONTOP}},
    ...
    [SPECIES_BELLSPROUT] = {{EVO_LEVEL, 22, SPECIES_WEEPINBELL}},
    ...
    [SPECIES_MAGNEMITE]  = {{EVO_LEVEL, 28, SPECIES_MAGNETON}},
    
    [SPECIES_DODUO]      = {{EVO_LEVEL, 20, SPECIES_DODRIO}},
    ...
    [SPECIES_SHELLDER]   = {{EVO_LEVEL, 28, SPECIES_CLOYSTER}},
    
    [SPECIES_GASTLY]     = {{EVO_LEVEL, 25, SPECIES_HAUNTER}},
    [SPECIES_HAUNTER]    = {{EVO_FRIENDSHIP, 250, SPECIES_GENGAR}},
    
    [SPECIES_ONIX]       = {{EVO_LEVEL_ITEM, ITEM_DEEP_SEA_SCALE, SPECIES_STEELIX}},
    ...
    [SPECIES_CHANSEY]    = {{EVO_FRIENDSHIP, 200, SPECIES_BLISSEY}},
    ...
    [SPECIES_PORYGON]    = {{EVO_TRADE, 0, SPECIES_PORYGON2}},
    
    [SPECIES_OMANYTE]    = {{EVO_LEVEL, 30, SPECIES_OMASTAR}},
    
    [SPECIES_KABUTO]     = {{EVO_LEVEL, 30, SPECIES_KABUTOPS}},
    
    [SPECIES_DRATINI]    = {{EVO_LEVEL, 24, SPECIES_DRAGONAIR}},
    ...
    [SPECIES_CLEFFA]     = {{EVO_FRIENDSHIP, 200, SPECIES_IGGLYBUFF}},
    ...
    [SPECIES_HOPPIP]     = {{EVO_LEVEL, 25, SPECIES_SKIPLOOM}},
    [SPECIES_SKIPLOOM]   = {{EVO_LEVEL, 40, SPECIES_JUMPLUFF}},
    
    [SPECIES_SUNKERN]    = {{EVO_FRIENDSHIP, 200, SPECIES_SUNFLORA}},
    
    [SPECIES_WOOPER]     = {{EVO_LEVEL, 22, SPECIES_QUAGSIRE}},
    
    [SPECIES_MURKROW]    = {{EVO_LEVEL, 25, SPECIES_SLOWKING}},
    [SPECIES_SLOWKING]   = {{EVO_LEVEL, 40, SPECIES_MISDREAVUS}},
    ...
    [SPECIES_PILOSWINE]     = {{EVO_TRADE, 0, SPECIES_SMOOCHUM}},
    
    [SPECIES_HOUNDOUR]   = {{EVO_LEVEL, 25, SPECIES_HOUNDOOM}},
    
    [SPECIES_PHANPY]     = {{EVO_LEVEL, 25, SPECIES_DONPHAN}},
    
    [SPECIES_LARVITAR]   = {{EVO_LEVEL, 24, SPECIES_PUPITAR}},
    [SPECIES_PUPITAR]    = {{EVO_LEVEL, 48, SPECIES_TYRANITAR}},
    ...
    [SPECIES_LINOONE]    = {{EVO_TRADE, 0, SPECIES_WURMPLE}},
    
    [SPECIES_LOTAD]      = {{EVO_LEVEL, 22, SPECIES_LOMBRE}},
    [SPECIES_LOMBRE]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_LUDICOLO},
                            {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_LUDICOLO}},
    
    [SPECIES_SEEDOT]     = {{EVO_LEVEL, 22, SPECIES_NUZLEAF}},
    ...
    [SPECIES_PLUSLE]     = {{EVO_LEVEL, 10, SPECIES_MINUN}},
    [SPECIES_MINUN]      = {{EVO_LEVEL, 10, SPECIES_PLUSLE}},
    
    [SPECIES_VOLBEAT]    = {{EVO_LEVEL, 28, SPECIES_ILLUMISE}},
    ...
    [SPECIES_RELICANTH]  = {{EVO_LEVEL, 40, SPECIES_LUVDISC}},
