...
const u8 gMoveDescription_Barrage[] = _("An extremely fast\nattack against one\ntarget. It can't be\nevaded."); // MOVE_MAGNET_BOMB
...
const u8 gMoveDescription_SpitUp[] = _("The user throws an\nfiery tackle.\nIt hurts the user\na little."); // MOVE_FLARE_BLITZ
const u8 gMoveDescription_Swallow[] = _("The user throws an\nhigh wave tackle.\nIt hurts the user\na little."); // MOVE_WAVE_CRASH
...
const u8 gMoveDescription_MudSport[] = _("The foe is attacked\nfrom beneath and\nlooses its balance that\nmay lower Ph.Def."); // MOVE_EARTH_POWER
...
const u8 gMoveDescription_Aromatherapy[] = _("An attack that raise\nall the user's stats.\nThe user flinches\nif hit beforehand."); // MOVE_FOCUS_BOOST
...
const u8 gMoveDescription_WaterSport[] = _("The foe is attacked\nfrom above and\nlooses its balance that\nmay lower sp.Def."); // MOVE_AZURE_DRIVE
